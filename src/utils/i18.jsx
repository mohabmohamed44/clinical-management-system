...
const resources = {
  ...
  en: {
    translation: {
      ...
      DepartmentsDescription: 'All medical departments at Dalma Healthcare Center are equipped with the latest technology and the best medical staff',
      ...
      OffersDescription: 'Take advantage of our specially designed medical packages that provide complete care pathways. Save on combined services while receiving coordinated treatment from our team of healthcare professionals.',
      ...
      HomeDescription: 'We are committed to providing you with the best medical and healthcare services to help you live healthier and happier.',
      BookNow: 'Book Now',
      ...
      HealthMonitoringCard: 'Regular medical check-ups and ongoing monitoring of your health', 
      MentalHealthServicesCard: 'Counseling, therapy, and other services to help patients manage mental health conditions',
      FollowUs: "Follow Us",
      ...
      FeatureSectionDescription: 'World-class care for everyone. Our health System offers unmatched, expert health care',
      Login: "Login",
      language: "English (US)",
    },
},
  ar: {
    translation: {
      ...
      OffersDescription: 'استفد من باقاتنا الطبية المصممة خصيصًا التي توفر مسارات رعاية كاملة. احصل على خصومات عند دمج الخدمات مع تلقي العلاج المنسق من فريقنا من المتخصصين في الرعاية الصحية.',
      ...
      FeatureSectionDescription: 'رعاية عالمية المستوى للجميع. يقدم نظامنا الصحي رعاية صحية متخصصة لا مثيل لها.',
      Continue: 'متابعة',
      Blog: 'المدونات',
      AboutUs: 'معلومات عنا',
      ...
      MentalHealthServicesCard: 'الاستشارة والعلاج وغيرها من خدمات لمساعدة المرضى على إدارة حالات الصحة العقلية',
      HomeContent: 'صحتك أولويتنا',
      HomeDescription: 'نحن متلزمون بتزويدك بأفضل خدمات الرعاية الطبية و الصحية لمساعدتك علي العيش بصحة و سعادة أكبر',
      ...
      DepartmentsDescription: 'جميع الأقسام الطبية المتوفرة في مركز دلما للرعاية الصحية، مجهزة بأحدث التقنيات وأفضل الكوادر الطبية',
      Name: 'الإسم كاملا',
      Subject: 'العنوان',
