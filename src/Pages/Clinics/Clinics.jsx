...
const fetchClinics = async () => {
  ...
  toast.success("Clinics loaded successfully");
  return data;
};
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {clinics.map((clinic) => (
              ...
              >
                <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow hover:shadow-[#667198] transition-shadow h-full">
                  <img
