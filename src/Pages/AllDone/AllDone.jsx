  ...
  return (
    <>
      <div className="container mx-auto pb-30 flex flex-col items-center justify-center h-screen text-center">
        ...
        <button className="w-1/3 text-white bg-[#11319e] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center mt-4">
