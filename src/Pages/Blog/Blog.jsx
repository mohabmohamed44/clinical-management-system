  ...
  return (
    <>
      <MetaData
        ...
        description="Read the latest health and wellness articles from our blog."
        keywords="health, wellness, fitness, nutrition, medicine, healthcare"
        author="Mohab Mohammed"
      />
      <div className="container mx-auto px-4 py-8">
        <div className="breadcrumbs bg-base-200 rounded-md text-md">
          <ul className="flex items-center text-[#274760] space-x-1">
            ...
            <li className="text-gray-500"><ChevronRight size={16} /></li>
            <li>
              <Link to="/blog" className="text-primary hover:underline">{t("Blog")}</Link>
            </li>
          </ul>
        </div>
        <h1
