...
export default function SearchCard() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 mt-60 sm:mt-60 md:mt-32 lg:mt-36 xl:mt-15">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="col-span-1 md:col-span-2">
              <label htmlFor="search" className={`block text-sm font-medium text-gray-700 mb-1 ${isRTL ? 'text-right' : 'text-left'}`}>
                {t('Search by doctor name or specialty')}
              </label>
            ...
            <div className="col-span-1">
              <label htmlFor="location" className={`block text-sm font-medium text-gray-700 mb-1 ${isRTL ? 'text-right' : 'text-left'}`}>
                {t('Location')}
              </label>
              <div className="relative rounded-md shadow-sm">
                <div className={`absolute inset-y-0 ${isRTL ? 'right-0 pr-3' : 'left-0 pl-3'} flex items-center pointer-events-none`}>
            ...
            {/* Date Input */}
            <div className="col-span-1">
              <label htmlFor="date" className={`block text-sm font-medium text-gray-700 mb-1 ${isRTL ? 'text-right' : 'text-left'}`}>
                {t('Date')}
              </label>
              <div className="relative rounded-md shadow-sm">
                <div className={`absolute inset-y-0 ${isRTL ? 'right-0 pr-3' : 'left-0 pl-3'} flex items-center pointer-events-none`}>
