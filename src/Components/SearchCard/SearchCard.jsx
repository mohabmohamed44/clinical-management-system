      ...
      <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 border border-gray-100">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className={`mt-4 flex ${isRTL ? 'justify-start' : 'justify-end'}`}>
            <button
              type="submit"
              className="flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#00155D] hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-md transition-all duration-300"
            >
              {t('FindDoctor')}
