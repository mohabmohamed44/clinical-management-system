...
export default function FilterDoctors({ onFilterChange }) {
  ...
  return (
    <div className="w-full p-6 bg-white rounded-xl shadow transition-all duration-300 hover:shadow-lg">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Customize your search results</p>
        </div>
